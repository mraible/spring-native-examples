...
----
+
Swagger doesn't seem to work, so I'm not sure this is necessary. In my browser's console, it says:
+
----
Failed to load resource: the server responded with a status of 404 (Not Found):8080/management/jhiopenapigroups
----
...
// todo: update to Cannot find 'compilePath' in class org.apache.maven.plugin.compiler.TestCompilerMojo
