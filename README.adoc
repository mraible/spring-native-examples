...
5. Liquibase is https://github.com/spring-projects-experimental/spring-native/issues/620[not supported yet]. Build with `./mvnw package -Pnative,prod,no-liquibase -DskipTests`
